...
| `Itoguruma.Installer` | `WixToolset.Sdk` | `5.0.2` | x64 MSIのビルド。 |
| `Itoguruma.Installer` | `WixToolset.UI.wixext` | `5.0.2` | MSIの言語選択UI。 |
| `Itoguruma.Installer` | `WixToolset.Util.wixext` | `5.0.2` | ログ付きMSIカスタムアクション実行。 |
